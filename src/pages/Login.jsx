...
export default function Login() {
  ...
  const handleLogin = () => {
  navigate("/sql-editor"); // or "/warehouse"
};
  return (
  ...
  style={{ width: '100%', marginTop: '12px', fontSize: '1.1rem', padding: '18px 0', borderRadius: '16px' }}
>
  Sign In
</button>
          </form>
          ...
          <div style={{ marginTop: '36px', fontSize: '0.95rem', color: '#777' }}>
            Don't have an account? <span onClick={() => navigate('/signup')} style={{ color: 'var(--v2-accent)', fontWeight: 800, cursor: 'pointer' }}>Sign up</span>
          </div>
        </div>
      </div>
    </div>
